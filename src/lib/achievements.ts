...
export function achievements(
  ...
  const list: Achievement[] = [
    ...
    milestone('alles-geuebt', 'stufen', 'silber', 'Überall geübt',
      'Jede trainierte Bewegung mindestens „Geübt“', atLeast(20), 1, '', 2),
    ...
    milestone('ueberall-stark', 'stufen', 'gold', 'Überall stark',
      'Jede trainierte Bewegung mindestens „Stark“', atLeast(60), 1, '', 2),
    milestone('gesamt-40', 'stufen', 'bronze', 'Gesamtrang 40',
      'Fortgeschritten im Gesamtrang', overall.score, 40, 'Punkte'),
    milestone('gesamt-60', 'stufen', 'silber', 'Gesamtrang 60',
      'Stark im Gesamtrang', overall.score, 60, 'Punkte'),
    milestone('gesamt-80', 'stufen', 'gold', 'Gesamtrang 80',
      'Elite im Gesamtrang', overall.score, 80, 'Punkte'),
